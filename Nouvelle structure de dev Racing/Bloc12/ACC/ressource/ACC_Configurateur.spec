# =============================================================================
#  ACC_Configurateur.spec — PyInstaller spec
#  Point d'entrée : Bloc11/ACC/ACC_configurateur.py
...
a = Analysis(
    [str(PROJET_ROOT / "Bloc11" / "ACC" / "ACC_configurateur.py")],
