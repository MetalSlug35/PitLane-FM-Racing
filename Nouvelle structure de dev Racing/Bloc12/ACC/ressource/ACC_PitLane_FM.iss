; =============================================================================
;  ACC_PitLane_FM.iss - Script Inno Setup
; =============================================================================

#define AppName        "ACC PitLane FM"
#define AppVersion     "1.0.0"
#define AppPublisher   "MetalSlug35"
#define AppExeName     "ACC_PitLane_FM.exe"
#define ConfigExeName  "ACC_Configurateur.exe"
#define AppId          "MetalSlug.ACCPitLaneFM"
#define Bloc11ACC      "..\..\..\Bloc11\ACC"
...
DefaultDirName={autopf64}\PitLane FM\ACC PitLane FM
DefaultGroupName={#AppName}
UninstallDisplayName={#AppName}
UninstallDisplayIcon={app}\{#AppExeName}
OutputDir=..\output
OutputBaseFilename=ACC_PitLane_FM_Setup
SetupIconFile={#Bloc11ACC}\ACC_PitLane_FM_icon.ico
...
[Files]
Source: "..\..\..\dist\ACC\ACC_PitLane_FM\*";          DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\..\..\dist\ACC\ACC_Configurateur\*";       DestDir: "{app}\Configurator"; Flags: ignoreversion recursesubdirs createallsubdirs
