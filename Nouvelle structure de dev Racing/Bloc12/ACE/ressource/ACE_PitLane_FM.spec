# =============================================================================
#  ACE_PitLane_FM.spec — PyInstaller spec
#  Point d'entrée : Bloc1/ACE/ACE_lanceur.py
...
a = Analysis(
    [str(PROJET_ROOT / "Bloc1" / "ACE" / "ACE_lanceur.py")],
    ...
    hiddenimports=[
        ...
        "Bloc3.ACE.ACE_state_monitor", "Bloc3.ACE.ACE_tableau_etats",
        "Bloc4.coordinateur",
