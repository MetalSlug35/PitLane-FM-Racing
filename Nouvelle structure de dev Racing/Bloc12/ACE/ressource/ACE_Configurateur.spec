# =============================================================================
#  ACE_Configurateur.spec — PyInstaller spec
#  Point d'entrée : Bloc11/ACE/ACE_configurateur.py
...
BLOC11_ACE   = PROJET_ROOT / "Bloc11" / "ACE"
BLOC11_SH    = PROJET_ROOT / "Bloc11" / "ressource"

datas = [
    (str(BLOC11_ACE / "ACE_PitLane_FM_icon.ico"),    "."),
    (str(BLOC11_SH  / "ACE_PitLane_FM_icon.png"),    "."),
...
a = Analysis(
    [str(PROJET_ROOT / "Bloc11" / "ACE" / "ACE_configurateur.py")],
...
exe = EXE(
    ...
    icon=str(BLOC11_ACE / "ACE_PitLane_FM_icon.ico"),
    version=str(PROJET_ROOT / "Bloc12" / "ACE" / "ressource" / "version_info.txt"),
    uac_admin=True,
)
