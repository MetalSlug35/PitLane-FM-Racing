# =============================================================================
#  AMS2_PitLane_FM.spec — PyInstaller spec
#  Point d'entrée : Bloc1/AMS2/AMS2_lanceur.py
...
BLOC11_AMS2  = PROJET_ROOT / "Bloc11" / "AMS2"
BLOC11_SH    = PROJET_ROOT / "Bloc11" / "ressource"

datas = [
    (str(BLOC11_AMS2 / "AMS2_PitLane_FM_icon.ico"),  "."),
...
a = Analysis(
    [str(PROJET_ROOT / "Bloc1" / "AMS2" / "AMS2_lanceur.py")],
    ...
    hiddenimports=[
        ...
        # AMS2 : shared memory custom ctypes — pas de pyaccsharedmemory
        "pygame", "pygame._sdl2", "pygame._sdl2.controller",
        "Bloc3.AMS2.AMS2_state_monitor", "Bloc3.AMS2.AMS2_tableau_etats",
        "Bloc4.coordinateur",
...
exe = EXE(
    ...
    icon=str(BLOC11_AMS2 / "AMS2_PitLane_FM_icon.ico"),
    version=str(PROJET_ROOT / "Bloc12" / "AMS2" / "ressource" / "version_info.txt"),
