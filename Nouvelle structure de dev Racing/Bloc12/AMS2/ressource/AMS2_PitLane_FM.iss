; =============================================================================
;  AMS2_PitLane_FM.iss - Script Inno Setup
; =============================================================================

#define AppName        "AMS2 PitLane FM"
#define AppVersion     "1.0.0"
#define AppPublisher   "MetalSlug35"
#define AppExeName     "AMS2_PitLane_FM.exe"
#define ConfigExeName  "AMS2_Configurateur.exe"
#define AppId          "MetalSlug.AMS2PitLaneFM"
#define Bloc11AMS2     "..\..\..\Bloc11\AMS2"
...
DefaultDirName={autopf64}\PitLane FM\AMS2 PitLane FM
DefaultGroupName={#AppName}
UninstallDisplayName={#AppName}
UninstallDisplayIcon={app}\{#AppExeName}
OutputDir=..\output
OutputBaseFilename=AMS2_PitLane_FM_Setup
SetupIconFile={#Bloc11AMS2}\AMS2_PitLane_FM_icon.ico
...
[Files]
Source: "..\..\..\dist\AMS2\AMS2_PitLane_FM\*";        DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\..\..\dist\AMS2\AMS2_Configurateur\*";     DestDir: "{app}\Configurator"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  Result :=
    ...
    DirExists(Root + 'LMU PitLane FM') or
    DirExists(Root + 'ACE PitLane FM');
end;
