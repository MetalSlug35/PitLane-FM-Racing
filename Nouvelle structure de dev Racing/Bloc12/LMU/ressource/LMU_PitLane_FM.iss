; =============================================================================
;  LMU_PitLane_FM.iss - Script Inno Setup
; =============================================================================

#define AppName        "LMU PitLane FM"
#define AppVersion     "1.0.0"
#define AppPublisher   "MetalSlug35"
#define AppExeName     "LMU_PitLane_FM.exe"
#define ConfigExeName  "LMU_Configurateur.exe"
#define AppId          "MetalSlug.LMUPitLaneFM"
#define Bloc11LMU      "..\..\..\Bloc11\LMU"
...
DefaultDirName={autopf64}\PitLane FM\LMU PitLane FM
DefaultGroupName={#AppName}
UninstallDisplayName={#AppName}
UninstallDisplayIcon={app}\{#AppExeName}
OutputDir=..\output
OutputBaseFilename=LMU_PitLane_FM_Setup
SetupIconFile={#Bloc11LMU}\LMU_PitLane_FM_icon.ico
...
[Files]
Source: "..\..\..\dist\LMU\LMU_PitLane_FM\*";          DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\..\..\dist\LMU\LMU_Configurateur\*";       DestDir: "{app}\Configurator"; Flags: ignoreversion recursesubdirs createallsubdirs
