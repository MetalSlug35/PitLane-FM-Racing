# =============================================================================
#  LMU_PitLane_FM.spec — PyInstaller spec
#  Point d'entrée : Bloc1/LMU/LMU_lanceur.py
...
a = Analysis(
    [str(PROJET_ROOT / "Bloc1" / "LMU" / "LMU_lanceur.py")],
    ...
    hiddenimports=[
        ...
        "Bloc3.LMU.LMU_state_monitor", "Bloc3.LMU.LMU_tableau_etats",
        "Bloc4.coordinateur",
