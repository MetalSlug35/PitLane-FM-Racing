# =============================================================================
#  Bloc1 — ACE_lanceur.py
#  Lanceur principal de ACE PitLane FM (Assetto Corsa EVO).
# =============================================================================
...
from Bloc3.ACE.ACE_state_monitor import find_process, get_state
from Bloc3.ACE.ACE_tableau_etats import POLITIQUE_MUSIQUE

APP_NAME         = "ACE PitLane FM"
APP_ID           = "MetalSlug.ACEPitLaneFM"
...
ICON_FILE        = "ACE_PitLane_FM_icon.ico"
...
def main():
    ...
    cfg.update({
        ...
        "check_interval":   ACE_CHECK_INTERVAL,
        "app_title":        APP_NAME,
        "app_id":           APP_ID,
